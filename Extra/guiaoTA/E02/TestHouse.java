...
public class TestHouse
{
  public static void main(String[] args)
  {
    ...
    out.println("\nNumero maximo de portas numa divisao: "+n);

    int roomId = h.roomClosestToRoomType("wc");
    out.println("\nDivisao mais proxima de um WC: "+roomId + " ("+h.room(roomId).roomType()+")");
    roomId = h.roomClosestToRoomType("quarto");
    out.println("\nDivisao mais proxima de um quarto: "+roomId + " ("+h.room(roomId).roomType()+")");
  }
}
