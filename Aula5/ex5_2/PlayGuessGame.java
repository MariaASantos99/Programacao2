		...
		try{
			...
			switch (command) {
				...
				default:
					...
					game.play(n);
					if(game.attemptIsHigher())System.out.printf("%d is too high\n",n);
					else if(game.attemptIsLower()) System.out.printf("%d is too low \n",n);
					break;
			}
		}catch(NumberFormatException e){
			System.out.printf("ERROR: invalid input(\"%s\")", command);
		}
      out.println();
    }
